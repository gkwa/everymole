...
import (
	...
	"github.com/gkwa/everymole/internal/logger"
)
...
func init() {
	...
	rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.everymole.yaml)")
